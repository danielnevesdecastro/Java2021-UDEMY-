...
public class AreaCircTeste {
	public static void main(String[] args) {
		...
		// AreaCirc.pi = 10; virou constante nao pode ser mais acessado para modificação
		...
		//método menbro da classe 
		System.out.println("Área Static :"+ AreaCirc.area(a2.raio));
		System.out.println("Área Static :"+ AreaCirc.area(100));
	}
}
